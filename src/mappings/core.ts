...
export function handleSwap(event: SwapEvent): void {
  ...
  // interval data
  let skyxDayData = updateSkyXDayData(event)
  ...
  skyxDayData.volumeETH = skyxDayData.volumeETH.plus(amountTotalETHTracked)
  skyxDayData.volumeUSD = skyxDayData.volumeUSD.plus(amountTotalUSDTracked)
  skyxDayData.feesUSD = skyxDayData.feesUSD.plus(feesUSD)
